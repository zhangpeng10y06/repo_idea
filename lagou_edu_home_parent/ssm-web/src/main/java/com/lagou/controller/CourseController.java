...
public class CourseController {
    ...
    //@RequestParam("file")这是干啥的？file要和接口文档中一致
    public ResponseResult fileUpload(@RequestParam("file")MultipartFile file, HttpServletRequest request) throws IOException {
        ...
        //2.获取项目部署路径
        // tomcat的项目部署路径，D:\apache-tomcat-8.5.56\webapps\ssm-web\
        String realPath = request.getServletContext().getRealPath("/");
        // 截取上面的路径备用，D:\apache-tomcat-8.5.56\webapps
        ...
        //4.生成新文件名防止重名
        //12421321.jpg，时间戳加文件后缀
        String newFileName = System.currentTimeMillis() + originalFilename.substring(originalFilename.lastIndexOf("."));

        //5.文件上传
        // String uploadPath = substring + "upload/";//mac上用\\会使得生成的文件夹名是upload/
    ...
    /*
        ...
        RequestBody：因为前端传过来的是个json串，我要将其中的信息封装到形参对象中
        courseVO.getId()：如果Id是int类型，则不能比较，只有是Integer才行
     */
